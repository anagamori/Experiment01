...
%--------------------------------------------------------------------------
dataFolder = '/Users/akiranagamori/Documents/GitHub/Experiment01/Record ID 03/Wrist flexion/';
...
for i = 1:10
    ...
    temp_1_3 = zscore(temp_1_2(end-10*Fs_HR+1:end));
    ...
    for j = 1:length(loc_sta)
        ...
        p2p_sta(j) = max(Force_sta(j,101:end),[],2)-min(Force_sta(j,101:end),[],2);
        low_amp(j) = temp_1_3(loc_sta(j));
    end
